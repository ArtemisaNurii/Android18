...
const CaseStudyHero = ({ title, subtitle, image }: { title: string; subtitle: string; image: string }) => (
  <header className="relative flex h-[70vh] min-h-[500px] flex-col justify-end p-8 text-white md:p-12 lg:p-16">
    ...
    <div className="relative z-10 max-w-4xl">
      ...
      <h1 className="font-serif text-4xl font-bold leading-tight md:text-5xl lg:text-6xl">{title}</h1>
      <p className="mt-4 max-w-2xl text-lg text-slate-200 md:text-xl">{subtitle}</p>
    </div>
  </header>
);
    ...
    <div className="bg-slate-50">
        <div className="mx-auto max-w-4xl px-4 py-16 text-center sm:px-6 lg:px-8 lg:py-24">
            ...
            <div className="mt-8">
                <a
                    href="/contact"
                    className="inline-flex items-center gap-2 rounded-md bg-teal-600 px-6 py-3 text-base font-semibold text-white shadow-sm hover:bg-teal-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-teal-600"
                >
...
/**
 * ---------------------------------------------
 *  🏗️  Main Case Study Detail Page Component (Re-assembled)
 * ---------------------------------------------
 */
  ...
  return (
    ...
    <main className="bg-white font-sans">
      <CaseStudyHero
        ...
        subtitle={caseStudyData.subtitle} image={"bac"}      />
